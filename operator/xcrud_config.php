...
{
    // default connection
    public static $dbname = 'monitoring_beasiswa'; // Your database name
    ...
    // theme and language
    public static $theme = 'w3'; // can be 'default', 'bootstrap', 'minimal' or your custom. Theme of xCRUD visual presentation. For using bootstrap you need to load it on your page.
